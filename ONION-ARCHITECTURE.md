...
Вопросы, которые мне казались простыми, совсем не очевидны джунам, что логично, но не всегда очевидно старшему разработчику.  
...
Код упрощен для понимания подхода, далее он будет эвалюционировать в сторону декларативного описания бизнес-логики.  
...
Этот класс привязан к определенному методу доступа к данным, находится вне ядра приложения. 
