...
Много новичков и старичков привыкли воспринимать приложения как «приложения баз данных» и теряют важную суть моделирования бизнес-процесса, не могут пробиться к пониманию зачем нам эти абстракции и какую задачу они решают.  
...
100% покрытие бизнес-логики юнит-тестами - это недооцениваемый подарок данного подхода к проектированию, который многие разработчики не видят, а ведь он ведет нас прямиком к сбалансированной Пирамиде Тестирования, надежному софту и качественному ИТ производству.  
...
- Уровень представления (Presentation Layer): Управляет пользовательскими интерфейсами и логикой, связанной с представлением. Точка входа нашего приложения для запуска бизнес-процесса. Например, REST API, терминал.
...
Есть графики у Владимира Хорикова и Мартина Фоллера, которые наглядно показывают, что на начальном этапе накидать говна и палок - быстро и дешево, но в долгосрочной перспективе это не выгодно и стоимость поддержки возрастает.   
...
Да я понимаю, что сразу делать правильно не просто. В любом мастерстве есть базовые вещи без которых не будет развития.  
...
Если одна вещь, которую мы уяснили о связывании за последние десятилетия - 
